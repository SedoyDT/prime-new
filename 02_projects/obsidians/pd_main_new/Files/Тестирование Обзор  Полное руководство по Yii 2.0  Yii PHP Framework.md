---
created: 2024-02-12T07:22:18 (UTC +03:00)
tags: []
source: https://www.yiiframework.com/doc/guide/2.0/ru/test-overview
author: 
tags:
 - web
 - firefox
...
# Тестирование: Обзор | Полное руководство по Yii 2.0 | Yii PHP Framework
...
> **Подсказка:** Если вы хотите узнать больше о принципах сбора требования программного обеспечения и моделирования предметной области, рекомендуем изучить [Проблемно-ориентированное проектирование (DDD)](https://en.wikipedia.org/wiki/Domain-driven_design).
