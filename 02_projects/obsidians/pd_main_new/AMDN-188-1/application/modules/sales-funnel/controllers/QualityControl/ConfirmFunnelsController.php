 ...
 * @date   10.08.2023
 * @copyright Copyright (c) ООО "Пиар Сити"
 * project AMDSolution
 */
...
/**
 * Контроллер функционала воронок с подтверждением ОКК
 */
class SalesFunnel_QualityControl_ConfirmFunnelsController extends Zend_Controller_Action
{
    /**
     * Сервис для получения данных
     * @\DI\Annotation\Inject()
     * @var FormDataSourceService
     */
    ...
    /**
     * Обработать запрос на получение воронок с флагом автоподтверждения
     * @return void
     * @throws Exception
     */
    ...
    /**
     * Обработать запрос на перезапись воронок с флагом автоподтверждения
     * @return void
     * @throws Exception
     */
