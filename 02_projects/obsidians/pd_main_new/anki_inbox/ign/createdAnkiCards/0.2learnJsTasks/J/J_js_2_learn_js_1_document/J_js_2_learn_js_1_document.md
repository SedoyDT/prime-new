...
#J_js_2_learn_js_1_document
#js_2_learn_js_1_document

#telegram 

# Что в общем можно сказать говоря о стандартах при использовании браузера и его компонентов при работе с кодом и тд?
<!-- basicblock-start oid="ObsF1xg74VCA9JMFgYj4lB3O"  deck='J_js_2_learn_js_1_document' -->
Что в общем можно сказать говоря о стандартах при использовании браузера и его компонентов при работе с кодом и тд?::
...
# Что является глобальным объектом для JavaScript кода ?
<!-- basicblock-start oid="ObsUmJ3nbjhCwbC7aoOgFzId"  deck='J_js_2_learn_js_1_document' -->
Что является глобальным объектом для JavaScript кода ?::
